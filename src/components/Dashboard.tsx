      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <button
            ...
            className="group relative flex flex-col items-start p-8 bg-[#1A1A1A] border border-purple-500/40 hover:border-purple-400 rounded-2xl glow-hover shadow-[0_0_30px_rgba(168,85,247,0.15)] transition-all duration-300 text-left overflow-hidden h-[300px] w-full"
          >
            <div className="absolute -right-4 -top-4 opacity-10 group-hover:opacity-20 transition-opacity">
              <span className="material-symbols-outlined text-[150px] text-purple-400">payments</span>
            </div>
            <div className="mb-auto z-10">
              <div className="w-14 h-14 rounded-xl bg-purple-500/20 border border-purple-500/40 flex items-center justify-center mb-6 text-purple-300">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Pay club fees, event passes, and merchandise securely via Razorpay with instant verification.
              </p>
            </div>
            <div className="mt-4 w-full flex items-center justify-between z-10">
              <span className="font-label-caps text-xs text-purple-400 font-bold group-hover:translate-x-2 transition-transform duration-300">
